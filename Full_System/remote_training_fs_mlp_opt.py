...
def main(parameters, i):
    ...
    params_mlp = parameters

    # Configure logging
    log_file = f'training_fullsystem_mlp{i}.log'
    ...
    for e in tqdm(range(params_mlp["epochs"])):
        ...
        train_error = train_mlp(train_loader_mlp, model_mlp, optimizer=optimizer, lr_scheduler=lr_scheduler)
        if (e+1) % 50 == 0:
    ...
    # Save trained model
    path_mlp = f'Full_System/or_mlp_{i}_{params_mlp["experiment_number"]}.pth'
