...
def load_data(num_inits):
    ...
    if os.name == "nt":
        ...
        input_data7 = get_data(path = r"C:\Users\strasserp\Documents\ventil_lstm\data_fs\training_data_full_system_closed_at_end.csv", num_inits=num_inits)
        ...
        input_data7 = get_data(path = r"/home/rdpusr/Documents/ventil_lstm/data_fs/training_data_full_system_closed_at_end.csv", num_inits=num_inits)


   
    input_data = torch.cat((input_data1, input_data2, input_data3, input_data4, input_data5, input_data6, input_data7))
