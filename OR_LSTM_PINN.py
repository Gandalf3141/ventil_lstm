...
def main():
    ...
    for k, params in enumerate(parameter_configs):
        ...
        for e in tqdm(range(params["epochs"])):
            ...
            if e > 300 and params["physics_loss_weight"]!=0:
                ...
                loss_epoch, physics_loss_epochs = train(train_loader, model, params["weight_decay"], learning_rate= params["learning_rate"],
                                        ws=params["window_size"], PSW_max=PSW_max, physics_loss_weight=0, phy_options = params["phy_options"])   
        ...
        # Save trained model
        path = f'Ventil_trained_NNs\OR_lstm_PINN_{params["experiment_number"]}.pth'
